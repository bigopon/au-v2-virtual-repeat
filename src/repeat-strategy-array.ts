...
// import { IView, ICollectionStrategy, VirtualizationCalculation, IScrollerInfo, IVirtualRepeater, IViewSlot } from './interfaces';
// import {
//   Math$abs,
//   Math$floor,
//   Math$max,
...
//  */
// export class ArrayVirtualRepeatStrategy extends ArrayRepeatStrategy implements ICollectionStrategy {

//   createFirstRow(repeat: IVirtualRepeater): IView {
//     const scope = Scope.fromParent(repeat.scope, repeat.items[0]);
//     return repeat.addView(scope.bindingContext, scope.overrideContext);
//   }
