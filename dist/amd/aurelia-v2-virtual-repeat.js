define(['exports', '@aurelia/kernel', '@aurelia/runtime', '@aurelia/runtime-html'], function (exports, kernel, runtime, runtimeHtml) { 'use strict';
    ...
    class CollectionObservationMediator {
        ...
        start(c) {
            ...
            this.stop();
            (_a = runtime.getCollectionObserver(this.c = c)) === null || _a === void 0 ? void 0 : _a.subscribe(this);
        }
        stop() {
            var _a;
            (_a = runtime.getCollectionObserver(this.c)) === null || _a === void 0 ? void 0 : _a.unsubscribe(this);
        }
    }
    class Calculation {
